...
export const getLocalizedServices = (_lang: 'ko' | 'en'): Service[] => {
  return [];
};
...
export const TRANSLATIONS = {
  ko: {
    ...
    successDesc: "고객님의 예약 신청이 성공적으로 접수되었습니다. 예약이 확정되는 시점에 개별 연락(이메일 또는 카카오톡 알림톡 등)을 받아보실 수 있습니다. 비회원으로 예약하신 경우, 상단 배너/메뉴의 '마이페이지(예약 조회)'에서 성함, 전화번호, 비밀번호로 언제든지 실시간 예약 현황 조회 및 취소가 가능합니다.",
    ...
    nonMemberVerifyDesc: "예약 신청 시 입력하셨던 성함, 휴대폰 번호, 비회원 비밀번호(4자 이상)를 입력하시면 예약 현황을 조회 및 취소하실 수 있습니다.",
    inputName: "성함",
    inputPhone: "휴대폰 번호",
    searchBtn: "예약 내역 조회",
